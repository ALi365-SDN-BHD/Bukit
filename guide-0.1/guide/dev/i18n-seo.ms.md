...
`site.rssMode` telah dibuang daripada konfigurasi pengguna dalam Bukit 1.0. Strategi feed dikawal melalui `site.feed` (terutamanya `site.feed.formats`) dan pilihan plugin feed; perilaku merged/split lama tidak disokong dalam konfigurasi 1.0.
## site.search.mode: `split`, `merged`, atau `index`
