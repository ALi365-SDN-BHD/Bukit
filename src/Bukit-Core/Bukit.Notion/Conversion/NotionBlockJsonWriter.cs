...
public static class NotionBlockJsonWriter
{
    public static string SerializeBlocks(IReadOnlyList<NotionBlock> blocks)
    {
    ...
    public static string TruncateBlockText(string text)
