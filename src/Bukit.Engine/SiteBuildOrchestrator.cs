...
internal sealed class SiteBuildOrchestrator
{
    ...
    internal SiteBuildOrchestrator(ILogger logger, IContentProviderFactory contentProviderFactory, ISearchIndexBuilder searchIndexBuilder, Func<string, ITemplateRenderer>? rendererFactory)
    {
        _logger = logger;
    ...
    internal async Task<BuildResult> BuildCoreAsync(BuildPipelineContext context, CancellationToken cancellationToken)
    {
    ...
    // -- private helpers from SiteEngine --
