...
When a user asks to make a theme easier to customize or wants a theme based on starter:
...
A well-designed theme starts with a consistent design token system via CSS custom properties. Define these in `assets/style.css` as `:root {}` variables.
