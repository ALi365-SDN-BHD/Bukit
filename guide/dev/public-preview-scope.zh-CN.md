# Bukit Core 1.0 稳定性范围

本文档定义 Bukit Core 1.0 的稳定承诺以及哪些能力仍处于预览阶段。
...
| 能力 | 状态 |
|---|---|
| 主题注册表 | Preview — 主题发现、搜索和注册表安装不属于 Bukit Core 1.0 稳定承诺 |
| 网站克隆→主题 | Preview — 浏览器提取到主题生成 |
| import html-demo 工作流 | Preview — HTML 导入到主题生成 |
| 外部插件生态（非 AOT） | Preview — 动态插件加载 |
| 高级 AI 自动化 | Preview — 多步骤 AI 构建流水线 |
| BukitJalil 本地控制面板 | Preview — 本地 Web UI 站点管理 |
