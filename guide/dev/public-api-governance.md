...
**Current inventory:** The [machine-readable public API baseline](../../docs/governance/bukit-core-public-api-baseline.v1.json)
...
recorded in the [approved quality-remediation plan](../../docs/superpowers/plans/2026-09-09-bukit-quality-remediation.md).
...
Historical AD-01 snapshot: The governed baseline still contains 14 assemblies and 425 public types; its
...
[quality remediation plan](../../docs/superpowers/plans/2026-09-09-bukit-quality-remediation.md).
...
`NotionFetchedPage` after `PagesIndexPlugin` became internal. Historical 425-type snapshot (not current): The current
