...
| **Asset hash mode** | `build.fingerprintMode: "sha256"` enables SHA256 content-based asset copy detection (recommended for CI and network filesystems). | Prevents unnecessary re-copying of unchanged assets |
