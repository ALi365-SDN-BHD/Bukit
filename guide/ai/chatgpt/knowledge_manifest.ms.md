# Senarai Cadangan Pengetahuan GPT

Fail berikut disyorkan untuk dimuat naik sebagai Pengetahuan "GPT Tersuai" untuk mengurangkan halusinasi dan menyelaraskan model kepada medan dan perintah.
...
- `examples/starter/site.modules.yaml`: Contoh pelbagai sumber + Modules (mode=data)

## Disyorkan (untuk diagnosis dan penyampaian lebih baik)
