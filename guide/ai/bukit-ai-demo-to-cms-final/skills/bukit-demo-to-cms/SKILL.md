...
Use this skill when the user wants to design, generate, convert, or validate a website that will ultimately run on Bukit.

This skill defines a two-stage workflow:
...
The goal is not to generate disposable HTML. The goal is to generate a maintainable Bukit site that can use Notion as a CMS.
...
- Notion-backed static websites

Do not use this workflow for highly interactive SaaS applications, complex authenticated systems, or client-side application platforms.
...
3. The Demo must be designed for migration, not as disposable HTML.
...
Return a concise site blueprint before generating files.
...
- List and detail pages are separate
- Template names are stable
