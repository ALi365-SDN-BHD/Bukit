...
public sealed class G04D2B1PluginHostErrorCodeContractTests
{
    ...
    private const string CurrentBaseline =
        "The current public API baseline contains 505 types, including 101 `2.0-candidate` entries.";
    ...
    [Fact]
    public void CurrentBaseline_ContainsFourteenAssemblies505TypesAnd101Candidates()
    {
        ...
        Assert.Equal(505, types.Length);
        Assert.Equal(101, types.Count(entry =>
