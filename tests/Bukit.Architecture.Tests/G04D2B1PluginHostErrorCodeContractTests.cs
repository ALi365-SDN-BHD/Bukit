...
public sealed class G04D2B1PluginHostErrorCodeContractTests
{
    ...
    private const string CurrentBaseline =
        "The current public API baseline contains 504 types, including 92 `2.0-candidate` entries.";
    ...
    [Fact]
    public void CurrentBaseline_ContainsFourteenAssemblies504TypesAnd92Candidates()
    {
        ...
        Assert.Equal(92, types.Count(entry =>
