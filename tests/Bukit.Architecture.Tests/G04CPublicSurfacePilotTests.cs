...
public sealed class G04CPublicSurfacePilotTests
{
    ...
    [Fact]
    public void ProductVersion_IsTheApprovedTwoPointZeroFourRelease()
    {
    ...
    public void ActiveGovernance_RecordsOnlyTheApprovedSingleTypeDecision()
    {
        ...
        const string currentBaseline = "The current public API baseline contains 425 types, including 0 `2.0-candidate` entries.";
