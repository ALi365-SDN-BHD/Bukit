...
public sealed class G04D2APluginSecretMaskerInternalizationTests
{
    ...
    private const string CurrentBaseline =
        "The current public API baseline contains 504 types, including 100 `2.0-candidate` entries.";
    ...
    [Fact]
    public void CurrentBaseline_ContainsFourteenAssemblies504TypesAnd100Candidates()
    {
        ...
        Assert.Equal(100, types.Count(type =>
