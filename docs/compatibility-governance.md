...
| `CG-021` | CLR public visibility is not a general SDK support promise | `supported-by-policy` | [Public API Governance](../guide/dev/public-api-governance.md), [public/protected baseline](governance/bukit-core-public-api-baseline.v1.json) | Medium | Before accepting any public/protected drift, review the baseline and classify every changed type/member with owner, compatibility, migration horizon, and reason. | `current` | Core / Docs |
