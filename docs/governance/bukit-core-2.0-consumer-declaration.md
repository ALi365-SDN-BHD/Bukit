...
`Bukit.Notion.Transport.NotionClientStats`; the other 5 candidates are not
batch-approved.

The current public API baseline contains 444 types, including 5
...
became internal. The current public API baseline contains 444 types, including 5 `2.0-candidate` entries.
...
`PluginCapability`. The current public API baseline contains 444 types, including 5 `2.0-candidate` entries.
