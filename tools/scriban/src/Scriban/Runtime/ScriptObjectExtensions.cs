...
namespace Scriban.Runtime
{
    ...
    static class ScriptObjectExtensions
    {
        ...
        /// </ul>
        /// </remarks>
        [RequiresUnreferencedCode("Import uses reflection to enumerate type members")]
        ...
        [RequiresUnreferencedCode("ImportMember uses reflection to enumerate type members")]
