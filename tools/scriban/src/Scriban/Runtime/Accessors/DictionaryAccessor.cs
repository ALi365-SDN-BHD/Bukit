...
namespace Scriban.Runtime.Accessors
{
    ...
    sealed partial class DictionaryAccessor : IObjectAccessor
    {
        ...
        [RequiresDynamicCode("Generic dictionary accessor uses MakeGenericType")]
        [RequiresUnreferencedCode("Generic dictionary accessor uses Activator.CreateInstance")]
