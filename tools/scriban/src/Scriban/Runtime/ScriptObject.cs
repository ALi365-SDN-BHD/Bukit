...
namespace Scriban.Runtime
{
    ...
    partial class ScriptObject : IDictionary<string, object>, IEnumerable, IScriptObject, IDictionary, IFormattable
    {
        ...
        [UnconditionalSuppressMessage("Trimming", "IL2026", Justification = "Builtin function types are statically referenced in DefaultBuiltins and preserved via DynamicDependency")]
