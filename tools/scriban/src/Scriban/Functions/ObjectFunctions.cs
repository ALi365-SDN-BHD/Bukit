...
#pragma warning restore CS0108
        ...
        /// ```
        /// </remarks>
        [UnconditionalSuppressMessage("AOT", "IL2026", Justification = "JsonElement is a well-known BCL type fully supported by the JSON serializer")]
        [UnconditionalSuppressMessage("AOT", "IL3050", Justification = "JsonElement is a well-known BCL type fully supported by the JSON serializer")]
            ...
            static void WriteValue(TemplateContext context, Utf8JsonWriter writer, object value)
            {
                switch (value)
                {
                    ...
                    case IFormattable fmt:
                        writer.WriteStringValue(fmt.ToString(null, System.Globalization.CultureInfo.InvariantCulture));
                        return;
                }
