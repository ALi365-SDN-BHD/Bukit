...
internal static class ApiPolicy
{
    ...
    [
        ...
        new("Bukit.Content.Notion", "src/Bukit-Core/Bukit.Content.Notion/Bukit.Content.Notion.csproj"),
        ...
        new("Bukit.Notion", "src/Bukit-Core/Bukit.Notion/Bukit.Notion.csproj"),
